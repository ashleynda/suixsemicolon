...
export default function Apply () {
    return (
        <div className="flex flex-wrap justify-center items-center gap-4 p-6 bg-[#EBF3FF]">
            <div className="bg-white p-4 rounded-xl shadow-lg flex flex-col justify-between items-center text-center w-full sm:w-64 md:w-72 h-56">
